...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-2 md:p-4 font-mono relative overflow-auto md:overflow-hidden">
      ...
      <div className="z-10 w-full flex justify-center h-full md:h-auto">
        <TerminalWindow title="pyspace_invaders.py">
            ...
            {/* Side Console - Hidden on very small screens if needed, or stacked */}
